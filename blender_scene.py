...
class BlenderScene:
    ...
    def __init__(self, max_torus_num = 2, render_pic_num = 2, max_deform = 10, save_image_folder_path = ""):
    ...
    def blender_render(self):
        ...
        bpy.ops.mesh.primitive_torus_add(
            align='WORLD', 
            location=(0, 0, 6),            # 位置 XYZ
            rotation=(0, math.radians(90), 0),        # 旋转 XYZ  
            major_radius=0.24,               # 圆环体内圆半径              major_radius + minor_radius= 圆环外径                     major_radius - minor_radius= 圆环内径
            minor_radius=0.078,               #环半径

            )
        bpy.context.object.name = "torus_1"  # 重命名环体
        ...
        for renderTimes in range(1,2):
            ...
            save_bmp = self._save_image_folder_path + "/" + currentTime + "_Render" + "/" + currentTime + "_" + str(renderTimes) + ".bmp"
